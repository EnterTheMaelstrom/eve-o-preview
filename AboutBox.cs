...
\pard\sa200\sl276\slmult1\b0\fs24 EVE-O Preview is a multi-client management tool which displays miniature windows, or previews, of your client(s) and allows you to switch between them easily. Thanks to StinkRay, the origional creator, this free and open source tool has a solid foundation. Since his disappearance and the ban of ISBoxer's automation, CCP FoxFour and Makari Aeron have contributed to the project. Due to the nature of the window tracking (Windows DLLs), Linux and Mac are not supported.\par
